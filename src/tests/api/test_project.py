...
class TestProjectEndpoints:
    ...
    STORAGE_FOLDER = 'My_project_folder'
    ...
    def test_update(self, client_as_admin: APIClient, project: Project):
        response = client_as_admin[0].put(f"{self.endpoint}/{project.pk}")
