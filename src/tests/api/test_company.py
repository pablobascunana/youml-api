...
class TestUserEndpoints:
    ...
    def test_list_companies_without_permission(self, client: APIClient):
    ...
    def test_create_company_and_user_with_existing_company_unique_fields(self, client: APIClient, company: Company,
                                                                         company_user: User):
    ...
    def test_create_company_and_user_with_existing_user_unique_fields(self, client: APIClient, company_user: User):
        company = {"name": "company_name", "email": "company_email@email.com", "cif": "C12571322"}
